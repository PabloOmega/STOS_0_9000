...
Drivers/io/%.o Drivers/io/%.su Drivers/io/%.cyclo: ../Drivers/io/%.c Drivers/io/subdir.mk
...
clean: clean-Drivers-2f-io

clean-Drivers-2f-io:
	-$(RM) ./Drivers/io/io.cyclo ./Drivers/io/io.d ./Drivers/io/io.o ./Drivers/io/io.su

.PHONY: clean-Drivers-2f-io
